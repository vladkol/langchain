...
def store(request: pytest.FixtureRequest) -> BigQueryVectorStore:
    """BigQueryVectorStore tests context."""
    TestBigQueryVectorStore.store = BigQueryVectorStore(
...
class TestBigQueryVectorStore:
    ...
    def test_semantic_search(self, store: BigQueryVectorStore) -> None:
    ...
    def test_semantic_search_filter_fruits(self, store: BigQueryVectorStore) -> None:
    ...
    def test_get_doc_by_filter(self, store: BigQueryVectorStore) -> None:
